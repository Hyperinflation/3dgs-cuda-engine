...
"""
================================================================================
POSTSHOT STUDIO PRO - CUDA 3DGS ENGINE (NVIDIA RTX 3090)
================================================================================
"""
...
if sys.platform == "win32":
    try:
        ctypes.windll.kernel32.SetPriorityClass(ctypes.windll.kernel32.GetCurrentProcess(), 0x00004000) # Below normal priority
    except Exception:
        pass
...
class GaussianModel(nn.Module):
    ...
    def densify_and_prune(self, max_grad=0.0001, min_opacity=0.005, max_gaussians=3500000):
        with torch.no_grad():
            ...
            # 3. Soft Prune (Protect baseline points)
...
def run_training(total_iterations=30000, save_interval=1000):
    ...
    for step in range(1, total_iterations + 1):
        ...
        # Emit structured log for Studio IPC UI
